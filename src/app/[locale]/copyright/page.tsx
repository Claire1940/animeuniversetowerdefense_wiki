      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animeuniversetowerdefense.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animeuniversetowerdefense.wiki</a>
            </p>
            <p>
