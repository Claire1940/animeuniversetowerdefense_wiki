      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@animeuniversetowerdefense.wiki</a>
            </p>
            <p>
