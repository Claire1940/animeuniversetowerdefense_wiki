...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.animeuniversetowerdefense.wiki'
  const path = '/about'
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Build useful tools:</strong> Develop tier lists, code trackers, and build planners that help players make informed decisions</li>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Detailed stats, rarities, roles, and skills for every anime-inspired unit.
                Learn how to summon and deploy each one.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                S to D rankings by DPS, support, control, and economy across every mode.
                Build the strongest defense with confidence.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">✨</div>
              <h3 className="text-xl font-semibold text-white mb-2">Traits & Evolutions</h3>
              <p className="text-slate-300">
                Reroll strategies, trait probabilities, and Etherealize evolution paths.
                Maximize each unit's potential.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🗺️</div>
              <h3 className="text-xl font-semibold text-white mb-2">Builds & Raids</h3>
              <p className="text-slate-300">
                Team compositions, relic setups, and walkthroughs for Story, Raids, Blitz,
                Virtual Realm, and Ultra Boss modes.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Thai, and Vietnamese to serve players worldwide.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Want to contribute?</strong> Whether you've found a new code, discovered a strong unit combo,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "Cosmic Tower" – Defending the universe together.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@animeuniversetowerdefense.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@animeuniversetowerdefense.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@animeuniversetowerdefense.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@animeuniversetowerdefense.wiki
                </a>
              </div>
            </div>
