        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox game updates and content may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@animeuniversetowerdefense.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@animeuniversetowerdefense.wiki</a>
            </p>
            <p>
